...
The **School District** application is a completely open-source full-stack, responsive (RWD) application, built with PostGIS, Leaflet, and a little TLC, that was spun off of the District Finder. The only difference is that this shows precincts as well.

See it in the wild at [http://gis.leg.mn](http://www.gis.leg.mn/iMaps/schooldistricts/)
